...
//      in->set_embedding_id(2);
  ...
  if (pileup_collision_rate>0)
  {
    ...
    pileup->AddFile("/sphenix/sim/sim01/sHijing/sHijing_9-11fm.dat");// HepMC events used in pile up collisions. You can add multiple files, and the file list will be reused.
