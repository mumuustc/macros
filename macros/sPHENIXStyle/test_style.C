...
test_style(void)
{
  ...
  TH1F * h1 = new TH1F("h1","H1;Mass [GeV];Counts [/ GeV];",20,0,20);
  TH1F * h2 = new TH1F("h2","H2;Mass [GeV];Counts [/ GeV];",20,0,20);
  ...
  TLegend * leg = new TLegend(.55,.70,.85,.93);
  ...
  c2->SetRightMargin(.2);
  TF2 * f2 = new TF2("f2","exp(-x/5)*sin(y)",-5,5,-5,5);
  //f2.SetContour(100);
  f2->SetNpx(100);
  f2->SetNpy(100);
  f2->Draw("surf2z");
